...
public class DBHelperSP extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table sanpham(id integer  primary key autoincrement, tensp text, giasp real, soluong real)");
        db.execSQL("insert into sanpham values(1, 'Bánh quy bơ LU Pháp', 45000, 10),"
